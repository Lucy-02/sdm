...
2. .claude/context/history/index.md   # 전체 문서 생성 이력
...
### 번호 관리
- 모든 번호는 `.claude/context/history/index.md`에 기록
- 생성 날짜/시간과 함께 기록
...
### 예시
```
001_initial_setup_plan.md (in plan/)
002_authentication_todo.md (in todo/)
003_database_structure.md (in structure/)
004_api_pattern.md (in DKB/)
005_user_management_plan.md (in plan/)
```
...
|----------|-------------------|--------------|
| **모든 작업** | `current.md` | 작업 위치, 다음 작업 |
| **파일 변경** | `structure/` 문서 | 생성/수정/삭제 |
| **패턴 발견** | `DKB/` 새 문서 | 해결책, 소요시간 |
| **용어 발견** | `lexicon/` 문서 | 정의, 사용처 |
| **차단 발생** | `dev_action/` 새 문서 | 필요 액션 |
| **할일 완료** | `todo/` 문서 | 체크박스, 진행상태 |
...
각 디렉토리의 상세 가이드는 해당 디렉토리의 CLAUDE.md 참조:
- [컨텍스트 관리](.claude/context/CLAUDE.md)
- [계획 작성](.claude/plan/CLAUDE.md)
- [할 일 관리](.claude/todo/CLAUDE.md)
