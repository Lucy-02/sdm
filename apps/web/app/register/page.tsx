...
import { Eye, EyeOff, Mail, Lock, User, Phone, Check, ArrowRight, Loader2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const isFormValid = agreements.terms && agreements.privacy && isPasswordValid && passwordValidation.match && formData.name && formData.email;
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-neutral-700 mb-1.5">
                휴대폰 번호 <span className="text-neutral-400">(선택)</span>
              </label>
              <div className="relative">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 h-12 border border-neutral-300 rounded-xl text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 h-12 bg-[#FEE500] rounded-xl text-sm font-medium text-[#000000] hover:bg-[#FDD800] transition-colors disabled:opacity-50"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path fill="#000000" d="M12 3c-5.52 0-10 3.58-10 8 0 2.84 1.89 5.33 4.72 6.73-.21.78-.78 2.84-.9 3.28-.14.54.2.53.42.38.17-.12 2.73-1.85 3.83-2.6.62.09 1.27.14 1.93.14 5.52 0 10-3.58 10-8s-4.48-8-10-8z" />
              </svg>
              카카오로 가입하기
            </button>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 h-12 bg-[#03C75A] rounded-xl text-sm font-medium text-white hover:bg-[#02B150] transition-colors disabled:opacity-50"
            >
